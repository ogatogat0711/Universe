...
public class Shooting : MonoBehaviour
{
   ...
   void FixedUpdate()
   {
      ...
      if (fpsCamera.IsLive && Input.GetMouseButtonDown(0)) // 左クリックで射撃
      {
   ...
   private void Shoot()
   {
      ...
      Quaternion rotation = Quaternion.LookRotation(direction) * Quaternion.AngleAxis(90, Vector3.right);//shotの向きをカメラの方向に合わせる
